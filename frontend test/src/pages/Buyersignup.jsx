        ...
        <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full pt-8">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
              ...
              <button type="submit" className="col-span-2 bg-[#3E4A3D] text-white py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-[#8FA189] transition-all">Register</button>
            </form>
          </div>
        </div>
